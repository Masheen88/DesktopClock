...
public partial class App : Application
{
    ...
    public static string GetTimeZoneAbbreviation(TimeZoneInfo timeZone)
    {
        ...
        var isDaylightSavingTime = timeZone.IsDaylightSavingTime(now);
        var timeZoneName = isDaylightSavingTime ? timeZone.DaylightName : timeZone.StandardName;

        var abbreviation = string.Join(string.Empty, timeZoneName.Split(' ')
